...
class Ui_ProductsWindow(object):
    def setupUi(self, ProductsWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../../resources/images/icons8-dodaj-produkt-30.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../../../resources/images/icons8-edytuj-produkt-30.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../../../resources/images/icons8-usuń-produkt-30.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
