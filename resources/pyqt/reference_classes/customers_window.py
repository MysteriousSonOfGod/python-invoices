...
class Ui_CustomersWindow(object):
    def setupUi(self, CustomersWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../images/icons8-dodaj-użytkownika-mężczyzna-30.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../../images/icons8-edycja-użytkownika-mężczyzna-30.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../../images/icons8-usuń-użytkownika-mężczyzna-30.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
